...
import { Eye, EyeOff, Loader2, AlertCircle, Trophy, Tv, BookOpen, Target, Brain } from "lucide-react";
  ...
  return (
    <div className="relative">
      <Input
        ...
        className={`bg-zinc-900/80 border-zinc-800 text-white placeholder:text-zinc-600
                   focus-visible:ring-zinc-600 pr-10
...
function FeatureCard({ icon, label, desc, accent, delay }: {
...
function RightPanel() {
  const features = [
    { icon: <Trophy size={15} />, label: "Sport Hub",   desc: "Football, Tennis, F1 en temps réel",  accent: "#10b981", delay: 0.2 },
    { icon: <Tv size={15} />,     label: "Watching",    desc: "Films, séries et animes organisés",   accent: "#8b5cf6", delay: 0.3 },
    { icon: <BookOpen size={15}/>, label: "Books",      desc: "Ta bibliothèque personnelle",          accent: "#f97316", delay: 0.4 },
    { icon: <Target size={15} />, label: "Goals & Pro", desc: "Objectifs, carrière et projets tech",  accent: "#6366f1", delay: 0.5 },
  ];
  ...
  return (
    <div className="hidden lg:flex flex-col justify-center h-full px-14 py-12 relative overflow-hidden">
      ...
      <div className="absolute -bottom-40 -left-20 w-72 h-72 rounded-full
                      bg-indigo-600/8 blur-[100px] pointer-events-none" />
      ...
      >
        ...
        <span className="text-lg font-bold text-white tracking-tight">Second Brain</span>
      </motion.div>
      ...
      >
        ...
        <p className="text-sm text-zinc-500 leading-relaxed max-w-xs">
          Ton espace personnel pour suivre le sport, les films,
          les livres et tes objectifs pro — sans friction.
        </p>
      </motion.div>
...
export default function AuthPage() {
  ...
  useEffect(() => {
    if (urlError === "auth_failed") setError("Authentification échouée. Réessaie.");
      ...
      <div className="flex flex-col justify-center px-8 sm:px-14 py-12 min-h-screen lg:min-h-0">
        ...
        >
          ...
          <Button
            ...
            className="w-full mb-6 bg-zinc-900 border-zinc-700/60 text-zinc-300
                       hover:bg-zinc-800 hover:text-zinc-100 hover:border-zinc-600
                       transition-all duration-150"
          >
            {googleLoading ? <Loader2 size={15} className="animate-spin mr-2" /> : <span className="mr-2"><GoogleIcon /></span>}
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
              ...
              {mode === "signup" && (
                ...
                >
                  <div className="space-y-1.5">
                    <Label htmlFor="name" className="text-zinc-400 text-xs">Prénom</Label>
                    <Input
                      id="name"
                      type="text"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="password" className="text-zinc-400 text-xs">Mot de passe</Label>
              <PasswordInput
                value={password}
            ...
            <AnimatePresence>
              {error && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0 }}
                  className="flex items-center gap-2 px-3 py-2.5 bg-red-500/10
                             border border-red-500/20 rounded-xl text-red-400 text-xs"
                >
              ...
              {success && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0 }}
                  className="flex items-center gap-2 px-3 py-2.5 bg-emerald-500/10
                             border border-emerald-500/20 rounded-xl text-emerald-400 text-xs"
                >
                  {success}
                </motion.div>
              )}
            ...
            <Button
              ...
              className="w-full mt-1 bg-gradient-to-r from-violet-600 to-indigo-600
                         hover:from-violet-500 hover:to-indigo-500
                         shadow-lg shadow-violet-500/20 font-semibold
                         transition-all duration-150"
            >
          ...
          <p className="text-center text-xs text-zinc-600 mt-6">
            ...
            <button
              type="button"
              onClick={() => { setMode(mode === "login" ? "signup" : "login"); clear(); }}
