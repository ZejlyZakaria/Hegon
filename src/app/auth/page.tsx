...
const FEATURES = [
  { icon: <Grid3x3 size={15} />, label: "All Connected",  desc: "Tasks, sports, media in one OS.",     delay: 0.55 },
  { icon: <Zap size={15} />,     label: "What Matters",   desc: "See the important, when it is.",      delay: 0.65 },
  { icon: <Sparkles size={15} />,label: "Built for You",  desc: "A system that adapts to your life.",  delay: 0.75 },
];
...
function FeatureCard({ icon, label, desc, delay }: {
  ...
  return (
    ...
    >
      ...
      <div>
        <p className="text-[10px] font-semibold uppercase tracking-wider leading-none" style={{ color: S.secondary }}>{label}</p>
        <p className="text-[10px] mt-1.5 leading-relaxed" style={{ color: S.tertiary }}>{desc}</p>
      </div>
    </motion.div>
  );
}
...
function PasswordInput({ value, onChange, autoComplete, hasError }: {
  value: string; onChange: (v: string) => void; autoComplete?: string; hasError?: boolean;
}) {
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center">
        ...
        >
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight" style={{ color: S.primary }}>
              HEGON
            </h1>
            <p className="text-[11px] mt-1.5 uppercase tracking-[0.22em]" style={{ color: S.tertiary }}>
      ...
      >
        ...
        <button type="button" className="hover:text-[#a0a0a8] transition-colors duration-100">Privacy Policy</button>
        <span style={{ color: "rgba(255,255,255,0.12)" }}>·</span>
        <button type="button" className="hover:text-[#a0a0a8] transition-colors duration-100">Terms of Use</button>
      </motion.div>
    </div>
  );
}
    ...
    <div className="min-h-screen bg-[#09090b] lg:grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center px-8 sm:px-16 py-12 min-h-screen lg:min-h-0">
        ...
        >
          {/* Heading */}
          <div className="mb-8">
            <p className="text-[10px] font-semibold uppercase tracking-[0.15em] mb-2" style={{ color: S.tertiary }}>
              {mode === "login" ? "Welcome Back" : "Get Started"}
            </p>
            <h1 className="text-3xl font-bold mb-2" style={{ color: S.primary }}>
              {mode === "login"
            ...
            <p className="text-sm" style={{ color: S.tertiary }}>
              {mode === "login" ? "Your dashboard is waiting." : "Start organizing everything that matters."}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {mode === "signup" && (
                ...
                >
                  <div className="space-y-1.5">
                    <Label htmlFor="name" className="text-xs font-medium" style={{ color: S.secondary }}>
                      Name
                    </Label>
                    <Input
                      id="name"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="email" className="text-xs font-medium" style={{ color: S.secondary }}>
                Email
              </Label>
              <Input
                id="email"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="password" className="text-xs font-medium" style={{ color: S.secondary }}>
                Password
              </Label>
              <PasswordInput
                value={password}
            ...
            <Button
              ...
              style={{ background: "linear-gradient(135deg, #7c3aed, #4f46e5)", boxShadow: "0 4px 24px rgba(124,58,237,0.25)" }}
            >
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t" style={{ borderColor: S.border }} />
            </div>
            <div className="relative flex justify-center">
              <span className="bg-[#09090b] px-3 text-[10px] uppercase tracking-[0.15em]" style={{ color: S.tertiary }}>
                Or continue with
              </span>
            </div>
          </div>
